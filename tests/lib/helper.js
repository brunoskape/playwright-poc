...
const createUser = async page => {
  await page.type('id=nome', faker.person.fullName())
  await page.type('id=email', faker.internet.email())
  await page.type('id=password', faker.internet.password())
  await page.click('id=checkbox')
  await page.click('id=cadastrar')
}
